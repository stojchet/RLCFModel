...
python3 src/evaluate/collect_predictions.py --config_path="$config_path" --config_name="$config_name" --add_config_path="$config_path" --add_config_name="$config_name" --path_to_prompt="$path_to_prompt" --batch_size="$batch_size"
